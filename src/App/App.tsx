...
const App = () => {
  ...
  const [dialogEditor, setDialogEditor] =
    useState<React.ReactElement>(<React.Fragment></React.Fragment>);
    ...
    >
      <Alert severity="warning">
        <Typography fontSize="large">
          This planner is no longer maintained. If you want to use a
          more polish planner, please visit this
          <br />
          <a
            rel="norefferer"
            href="https://eurydia.github.io/pso2ngs-character-simulator/"
            target="_blank"
          >
            site
          </a>
      ...
      >
        ...
        >
          <AugPresBuilder
            onSave={(new_preset) => {
              addPreset(new_preset, setAugPresets, enqueueSnackbar);
            }}
          />
        </PaperBackground>
        <PaperBackground
        ...
        >
          <AugPresManager
            ...
            onDuplicate={(index) =>
              duplicatePreset(index, setAugPresets, enqueueSnackbar)
            }
            onDelete={(index) =>
              deletePreset(index, setAugPresets, enqueueSnackbar)
            }
            onImport={(data) =>
              importPreset(
                data,
      ...
      >
        ...
        >
          <LoadoutPresManager
            ...
            onDelete={(index) =>
              deletePreset(index, setLoadoutPresets, enqueueSnackbar)
            }
            onImport={(data) =>
              importPreset(
                data,
